...
-   Afin de vérifier la cohérence globale de nos résultats, on regroupe ci-dessous les estimateurs déjà calculés plus haut et on y ajoute le HR issu du modèle de Cox multivarié sur la population totale. Cela permet de comparer directement l'effet du RHC selon le critère étudié et la stratégie d'ajustement.
