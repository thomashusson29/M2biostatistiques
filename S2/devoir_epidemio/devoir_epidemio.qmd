...
-   Les variables ayant une différence moyenne standardisée supérieure à 0.1 en valeur absolue sont : 

    -  Score ADL (SMD = `r abs(round(balance_baseline_clean$Balance["adl_score", "Diff.Un"], 3))`)

    -  Score de Glasgow (SMD = `r abs(round(balance_baseline_clean$Balance["glasgow_score", "Diff.Un"], 3))`)

    -  Score APACHE (SMD = `r abs(round(balance_baseline_clean$Balance["apache_score", "Diff.Un"], 3))`)

    -  Diagnostic primaire choc septique (SMD = `r abs(round(balance_baseline_clean$Balance["primary_binaire_choc_septique_Yes", "Diff.Un"], 3))`)

    -  Diagnostic associé respiratoire (SMD = `r abs(round(balance_baseline_clean$Balance["diagnosis_respiratory_Yes", "Diff.Un"], 3))`)

    -  Diagnostic associé cardiovasculaire (SMD = `r abs(round(balance_baseline_clean$Balance["diagnosis_cardiovascular_Yes", "Diff.Un"], 3))`)

    -  Diagnostic associé neurologique (SMD = `r abs(round(balance_baseline_clean$Balance["diagnosis_neurological_Yes", "Diff.Un"], 3))`)

    -  Poids (SMD = `r abs(round(balance_baseline_clean$Balance["weight", "Diff.Un"], 3))`)

    -  Pression artérielle moyenne (SMD = `r abs(round(balance_baseline_clean$Balance["mean_blood_pressure", "Diff.Un"], 3))`)

    -  Fréquence cardiaque (SMD = `r abs(round(balance_baseline_clean$Balance["heart_rate", "Diff.Un"], 3))`)

    -  Fréquence respiratoire (SMD = `r abs(round(balance_baseline_clean$Balance["respiratory_rate", "Diff.Un"], 3))`)

    -  Ratio Pa/FI (SMD = `r abs(round(balance_baseline_clean$Balance["pa_fi_ratio", "Diff.Un"], 3))`)

    -  Albumine (SMD = `r abs(round(balance_baseline_clean$Balance["albumin", "Diff.Un"], 3))`)

    -  Hématocrite (SMD = `r abs(round(balance_baseline_clean$Balance["hematocrit", "Diff.Un"], 3))`)

    -  Bilirubine (SMD = `r abs(round(balance_baseline_clean$Balance["bilirubin", "Diff.Un"], 3))`)

    -  Créatinine (SMD = `r abs(round(balance_baseline_clean$Balance["creatinine", "Diff.Un"], 3))`)

    -  PaCO2 (SMD = `r abs(round(balance_baseline_clean$Balance["paco2", "Diff.Un"], 3))`)

    -  pH (SMD = `r abs(round(balance_baseline_clean$Balance["ph", "Diff.Un"], 3))`)
...
### Histogramme de densité du score de propension avant et après appariement
...
-   Le risque instantané de décès à 180 jours est multiplié par 1.23 chez les patients ayant eu un RHC par rapport à ceux n'ayant pas eu de RHC, avec un intervalle de confiance à 95% allant de 1.11 à 1.36, et une p-value < 0.001.
...
-   On trouve un risque instantané de décès à 180 jours multiplié par 1.23 chez les patients ayant eu un RHC par rapport à ceux n'ayant pas eu de RHC, avec un intervalle de confiance à 95% allant de 1.11 à 1.36, et une p-value < 0.001. 
...
-   L'analyse multivariable ajustée pour les variables basales a permis d'estimer l'association entre le RHC et le risque de décès à 180 jours en ajustant pour les variables basales qui pourraient confondre cette association, et les résultats sont similaires à ceux obtenus dans la population appariée.
