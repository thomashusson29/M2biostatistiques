...
![Représentation géométrique d’un tableau de données : les sujets sont symbolisés par des points (ici des « O »), les variables par les dimensions de l’espace.](images/paste-73.png){width="468"}
...
![On recherche dans un premier temps la direction suivant laquelle le nuage de points s’étire au maximum](images/paste-74.png){width="488"}
...
![A cette direction correspond une variable dont la variance est maximale : c’est la première composante principale](images/paste-75.png){width="493"}
...
![Pour obtenir la seconde composante principale, il faut projeter les points sur un plan perpendiculaire à la première composante](images/paste-76.png){width="499"}
...
![Recherchons dans un second temps la direction suivant laquelle les projections s’étirent au maximum.](images/paste-77.png){width="516"}

![A cette direction correspond une variable dont la variance est maximale : c’est la seconde composante principale.](images/paste-78.png){width="541"}

Et la troisième composante principale est représentée de la même manière

![En dimension 3, la troisième et dernière composante principale est perpendiculaire aux deux premières.](images/paste-79.png){width="508"}
...
![Si l’on projette les points sur le plan formé par les deux premières composantes principales, ce plan maximise la somme des di2 et minimise la somme des \$\text{e}\_i\^2](images/paste-80.png){width="580"}
...
![](images/paste-81.png){width="171"}

Sur 5 points, 2 et 3 sont proches.

![](images/paste-82.png){width="373"}
