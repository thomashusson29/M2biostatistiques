...
## Synthèse mesures additives et multiplicatives
...
Additives :
-   Linéaire (mais on pourrait calculer un rapport de moyennes)

Certains modèles donnent directement une mesure additive (linéaire) ou multiplicative (logistique, Cox, Poisson).

On peut aussi calculer des mesures additives à partir de modèles multiplicatifs en utilisant des techniques spécifiques, rendant l'interprétation des résultats plus facile mais la réalisation est plus complexe.

# que faire en cas de risques non proportionnels ?

-   faire un modèle de cox quand même

-   modéliser l'interaction avec le temps
