...
L'objectif est de modéliser une variable à expliquer qui est 

-   un "processus stationnaire", 

-   aléatoire, avec une moyenne dans le temps 

-   et pour lequel la corrélation de la mesure au temps $t_1$ avec la mesure au temps $t_2$ dépend uniquement de la distance entre $t_1$ et $t_2$.
